...
function NearestSubway(address, callBack, googleMap, mode, googleKey)  {
    ...
    this.fault = function (message) {
        callBack(null, false, message, null);
    };
    /**
     * begin async request
     */
    this.run = function () {
        ...
        function (results, status) {
            if (status == google.maps.GeocoderStatus.OK) {
                ...
                that.address_components = function (){
    ...
    this.estimateTime = function(points, latlng) {
        ...
        function (response, status) {
            that.matrixGot(response, status, points);
        });
    };
    /**
