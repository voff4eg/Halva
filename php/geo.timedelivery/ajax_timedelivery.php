...
$addressStart = htmlspecialchars($_GET['addressStart']); // Адрес клиента
$restaurantId = (int) $_GET['restaurant']; // id ресторана
$deliveryType = htmlspecialchars($_GET['deliveryType']); // Тип доставки
